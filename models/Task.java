...
public class Task {
    ...
    public Task(String title, String description, Priority priority, LocalDate dueDate, String category) {
        this.id = UUID.randomUUID().toString();
        this.title = title;
    ...
    public Task(String id, String title, String description, Priority priority, LocalDate dueDate,
                boolean completed, LocalDateTime createdAt, LocalDateTime completedAt, String category) {
        this.id = id;
        this.title = title;
        this.description = description;
        this.priority = priority;
